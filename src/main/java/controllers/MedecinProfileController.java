...
public class MedecinProfileController {
    ...
    private void enregistrer(ActionEvent event) {
        ...
        try {
            ...
            showInfo("Profil medecin mis a jour avec succes.");
    ...
    private boolean valider() {
        ...
        if (nomField.getText().isBlank()) message.append("- Le nom est obligatoire.\n");
        if (prenomField.getText().isBlank()) message.append("- Le prenom est obligatoire.\n");
        if (emailField.getText().isBlank()) message.append("- L'email est obligatoire.\n");
        if (telephoneField.getText().isBlank()) message.append("- Le telephone est obligatoire.\n");
        if (adresseField.getText().isBlank()) message.append("- L'adresse est obligatoire.\n");
        if (sexeCombo.getValue() == null) message.append("- Le sexe est obligatoire.\n");
        if (!nouveauMotDePasseField.getText().isBlank()

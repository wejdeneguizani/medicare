...
public class Stock {
    ...
    public Stock(int idStock, int idMedicament, String numeroLot, int quantite,
                 int seuilAlerte, double prixUnitaire, Date dateExpiration,
                 Date dateReception, String localisation, String fournisseur) {
    ...
    public String toString() {
        return "╔══════════════════════════════════════╗\n" +
                "  ID Stock     : " + idStock + "\n" +
                "  ID Médic.    : " + idMedicament + "\n" +
                "  Lot          : " + numeroLot + "\n" +
                "  Quantité     : " + quantite + "\n" +
                "  Seuil alerte : " + seuilAlerte + "\n" +
                "  Prix         : " + prixUnitaire + " TND\n" +

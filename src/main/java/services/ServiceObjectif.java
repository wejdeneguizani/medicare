...
public class ServiceObjectif implements IService<Objectif> {
    ...
    public List<Objectif> rechercher(String motCle) {
        List<Objectif> liste = new ArrayList<>();
        String req = "SELECT * FROM objectif WHERE titre LIKE ?";
        try {
            PreparedStatement ps = cnx.prepareStatement(req);
    ...
    public List<Objectif> filtrerParStatut(String statut) {
        List<Objectif> liste = new ArrayList<>();
        String req = "SELECT * FROM objectif WHERE statut = ?";
        try {
            PreparedStatement ps = cnx.prepareStatement(req);
    ...
    public List<Objectif> trierParPriorite() {
        List<Objectif> liste = new ArrayList<>();
        String req = "SELECT * FROM objectif ORDER BY priorite ASC";
        try {
            Statement st = cnx.createStatement();
            ResultSet rs = st.executeQuery(req);
            while (rs.next()) {
            ...
            System.out.println("❌ Erreur tri priorite : " + e.getMessage());
        }
        return liste;
    }

    public List<Objectif> trierParDateEcheance() {
        List<Objectif> liste = new ArrayList<>();
        String req = "SELECT * FROM objectif ORDER BY date_echeance ASC";
        try {
            Statement st = cnx.createStatement();
            ResultSet rs = st.executeQuery(req);
            while (rs.next()) {
            ...
            System.out.println("❌ Erreur tri date : " + e.getMessage());
        }
        return liste;
    }
}